...
test('validate.request(requestObject)', t => {
    ...
    t.throws(() => v({notAllowMethod: "foo"}), /Error.*?this method name "notAllowMethod" is not allowed/, 'validator.request({notAllowMethod: "foo"}) thorw Error')
...
test('validate.response(responseObject)', t => {
    ...
    t.throws(() => v({notAllowMethod: "foo"}), /Error.*?this method name "notAllowMethod" is not allowed/, 'validator.response({notAllowMethod: "foo"}) thorw Error')
...
test('validate.error(responseErrorObject)', t => {
    ...
    t.throws(() => v({notAllowMethod: "foo"}), /Error.*?this method name "notAllowMethod" is not allowed/, 'validator.error({notAllowMethod: "foo"}) thorw Error')
    ...
    t.throws(() => v({jsonrpc: "2.0", id: null, error: {code: -32000, message: 'foo', notAllowMethod: 'hoge'}}), /Error.*? this method name "notAllowMethod" is not allowed/, 'validator.error({jsonrpc: "2.0", id: null, error: {code: -32000, message: "foo", notAllowMethod: "hoge"}}) throw Error # error.notAllowMethod')
